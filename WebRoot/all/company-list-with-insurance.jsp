	...
	<div id="container">
		...
		<div id="main"> 
          ...
          <ul class="nav nav-tabs">
            <li>
              <a href="company-list-with-salary.html">工资</a>
            </li>            
            <li  class="active">
              <a href="company-list-with-insurance">增减员与参保</a>
            </li>
          ...
          <table class="table table-striped table-bordered">
            ...
            <tbody>
              <tr>
                ...
                <td>2013年1月</td>
                <td>
                  <a href="../company/insurance-with-employee-list.html">新增员工3人，减员2人，参保3人
                  </a>
                </td>
                <td>已完成</td>
                <td>---</td>
      ...
      <div class="row-fluid">
        <form action="" method="post">
            ...
            <div class="input-container">
              <label>&nbsp;</label>
              <input type="radio" name="iscompleted" value="0" checked="checked">未执行，
              <input type="radio" name="iscompleted" value="1">执行中，
              <input type="radio" name="iscompleted" value="2">已完成
            </div>
