...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<%@ include file="/help/public_css_js.jsp"%>
		<script>
			...
			{
				var form = document.getElementById("hideEmployees");
		...
		<div id="container">
			...
			<div id="main">
				<div class="row-fluid">
					...
					<s:form action="hideEmployees" method="post" id="hideEmployees">
						 <input type="hidden" name="page"/>
						  <input type="hidden" name="pseudoDelete" value="${pseudoDelete}"/>
