	...
	<head>
		...
		<script type="text/javascript">
			 function topage(page){
				var form = document.getElementById("viewDepletion");
			...
			<div id="main">
				<div class="row-fluid">
					<div id="center-pane">
						...
						<s:form action="viewDepletion" method="post" id="viewDepletion">
							<s:hidden name="page"/>
							<s:hidden name="insuranceYear"/>
							<s:hidden name="month"/>
							<input type="hidden" name="staff_renewal_reduction" value="3"/>
