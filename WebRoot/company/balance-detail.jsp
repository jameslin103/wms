      ...
      <div class="row-fluid">
        ...
        <div id="center-pane">
          <ul class="nav nav-tabs">
            ...
            <li class="active"><a href="balance-detail.html">资金往来</a></li>            
          </ul>
          ...
          <table class="table table-striped table-bordered">
            ...
            <tbody>
              <tr>
                ...
                <td>-300</td>
                <td>-200</td>
                <td rowspan="2"><a href="#info-for-check" data-toggle="modal">填写</a></td>
              </tr>
              <tr>
                <td colspan="11" class="align-right">备注显示在这里（倪姐，2013年8月6日，19:36）</td>
              </tr>
              <tr>
                <td rowspan="2">2</td>
                <td>2013年3月</td>
